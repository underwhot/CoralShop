    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                } else if (bodyLockStatus && !e.target.closest(".menu__body") && document.documentElement.classList.contains("lock")) {
                    bodyLockToggle();
        ...
        function initSliders() {
            if (document.querySelector(".best__slider")) {
                var sliderBest = new core(".best__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                ...
                (function() {
                    const buttons = document.querySelectorAll(".best .navigation-tabs__button");
                    const products = document.querySelectorAll(".best .card-product");
                    buttons.forEach((function(button) {
                        button.addEventListener("click", (function(e) {
                            ...
                            products.forEach((function(item) {
                                if (filter === "all") item.style.display = "flex"; else if (item.dataset.filter === filter) item.style.display = "flex"; else item.style.display = "none";
                            }));
                            sliderBest.update();
                        }));
                    }));
        ...
        window.addEventListener("load", (function(e) {
            ...
            (function() {
                ...
                document.addEventListener("click", (function(e) {
                    if (e.target === searchButton && !searchForm.classList.contains("form-active")) {
                        e.preventDefault();
                        searchForm.classList.add("form-active");
                        searchInput.focus();
                    } else if (e.target === searchInput) e.stopPropagation(); else searchForm.classList.remove("form-active");
                }));
            })();
            (function() {
                const header = document.querySelector(".header");
                const headerTop = document.querySelector(".top-header");
                const headerBot = document.querySelector(".bot-header");
                window.addEventListener("scroll", (function(e) {
                    if (window.scrollY > headerTop.clientHeight) {
                        console.log(window.scrollY);
                        header.classList.add("_ontop");
                        header.style.paddingBottom = headerBot.clientHeight + "px";
                    } else {
                        header.classList.remove("_ontop");
            ...
            (function() {
                ...
                socialItems.forEach((function(item) {
                    item.addEventListener("mouseenter", (function(e) {
                        if (item.classList.contains("_anim")) return;
            ...
            (function() {
                const buttons = document.querySelectorAll(".products .navigation-tabs__button");
                const products = document.querySelectorAll(".products .card-product");
                buttons.forEach((function(button) {
                    button.addEventListener("click", (function(e) {
                        buttons.forEach((function(button) {
                            button.classList.remove("_active");
            ...
            (function() {
                ...
                sortButtons.forEach((function(button) {
                    button.addEventListener("click", (function(e) {
                        ...
                        this.classList.add("_active");
                        const spollersBlock = this.closest("[data-spollers]");
                        const spollerBody = spollersBlock.querySelector(".filter-products__body");
                        const spollerBtn = spollersBlock.querySelector(".filter-products__button");
                        const spollerSpeed = 500;
                        spollerBtn.classList.remove("_spoller-active");
                        _slideUp(spollerBody, spollerSpeed);
                        if (e.target.dataset.sort === "ascending") sortAscending();
                        if (e.target.dataset.sort === "descending") sortDescending();
                    }));
                }));
            })();
            function sortAscending() {
                const sortingBody = document.querySelector(".products__content");
                for (let i = 0; i < sortingBody.children.length - 1; i++) for (let j = i + 1; j < sortingBody.children.length; j++) if (parseInt(sortingBody.children[i].querySelector(".card-product__current-price").textContent.replace(/[^\d]/g, "")) > parseInt(sortingBody.children[j].querySelector(".card-product__current-price").textContent.replace(/[^\d]/g, ""))) {
                    let replacedNode = sortingBody.replaceChild(sortingBody.children[j], sortingBody.children[i]);
                    insertAfter(replacedNode, sortingBody.children[i]);
                }
            }
